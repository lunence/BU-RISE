...
from model_training.util.apriltag import AprilTag
from model_training.datasets.synthetic_dataset.generate_synthetic_data import random_background
...
def extract_frames(video_path, output_folder):
    ...
    background_folder = (
        ...
        "model_training/datasets/synthetic_dataset/backgrounds"
    )
...
def main():
    extract_frames(
        "model_training/datasets/video_dataset/video_dataset.mov",
        "model_training/datasets/video_dataset/frames"
    )
