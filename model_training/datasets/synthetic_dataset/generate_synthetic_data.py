...
import json
import os
from model_training.util.utils import normalize_coords
...
def generate_synthetic_dataset(size):
    ...
    robot_path = "model_training/real_world_dataset/real_limo2.png"
    background_path = 'model_training/real_world_dataset/backgrounds'
    ...
    for i in range(size):
        ...
        cv2.imwrite(f'model_training/real_world_dataset/images/transformed_limo_{i}.jpg', noisy_image)

    with open("model_training/real_world_dataset/ground_truth.json", "w") as file:
